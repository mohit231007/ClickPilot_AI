...
- a Streamlit frontend for single-impression scoring and batch ranking,
- a FastAPI backend with documented prediction endpoints,
...
1. Open the home page and show the original case-study KPI cards.
...
6. **Product architecture** — Streamlit + FastAPI + shared Python package.
...
9. **Live proof** — demo URL + GitHub + PDF case study.
